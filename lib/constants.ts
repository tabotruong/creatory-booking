...
export const DEMO_USERS: User[] = [
  ...
  { id: '2', email: 'dat@creatory.vn', name: 'Đạt Camera', role: 'cameraman', avatar: '🎥' },
  { id: '3', email: 'giang@creatory.vn', name: 'Giang Camera', role: 'cameraman', avatar: '🎥' },
  { id: '4', email: 'content1@creatory.vn', name: 'Trần Thị A', role: 'content_team', avatar: '👩‍💻' },
  { id: '5', email: 'content2@creatory.vn', name: 'Nguyễn Văn B', role: 'content_team', avatar: '👨‍💻' },
]
